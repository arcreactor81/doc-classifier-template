/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --strict-vars=false` (hash: 9308e99780988a91b03c7123871ff84a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROJECT_ID" | "MODEL_CALLS_ENABLED" | "BUILD_COMMIT">> {}
}
declare module "*.txt" {
	const value: string;
