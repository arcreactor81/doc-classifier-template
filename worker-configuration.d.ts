/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.template.jsonc --strict-vars=false` (hash: af8663cf883463b653dd21dc3584af81)
// Runtime types generated with workerd@1.20260921.1 2026-09-23
interface __BaseEnv_Env {
	ARTIFACTS: R2Bucket;
	DB: D1Database;
	OPENAI_API_KEY: SecretsStoreSecret;
	JEV_API_KEY: SecretsStoreSecret;
	PROJECT_ID: string;
	MODEL_CALLS_ENABLED: string;
	BUILD_COMMIT: string;
	DEFINITION_MODE: string;
	DEFINITION_EDITORS: string;
	DOCUMENT_WORKFLOW: Workflow<Parameters<import("./core/server/managed-worker").DocumentWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./core/server/managed-worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROJECT_ID" | "MODEL_CALLS_ENABLED" | "BUILD_COMMIT" | "DEFINITION_MODE" | "DEFINITION_EDITORS">> {}
}
declare module "*.txt" {
	const value: string;
