/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=generic` (hash: 0edd65ebc0203038ff87f40645e29964)
...
interface __BaseEnv_Env {
	...
	DOCUMENT_WORKFLOW: Workflow<Parameters<import("./core/server/worker").DocumentWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./core/server/worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROJECT_ID" | "MODEL_CALLS_ENABLED" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "BUILD_COMMIT">> {}
}
