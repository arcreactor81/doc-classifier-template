...
### Wait completion and partial continuation (2026-09-24)
Persistabsolute workflowwaitdeadlines and recheck current execution guards. A known lifecycle reset after the saveddeadline may reconcile waiting without repeatingactions; earlyinterruption/storagefailures remainexplicit. Completedcallbackdurablekeys are authoritative acrossouterSDKacknowledgementwording; callbackerrors remainfailures. Partiallyscheduledrecovery distinguishesimmutablependingreservations fromuncertainstarts: pendingmeans no createwasissued, dispatchingmustreconcileexactreservedID. No blindreplacement/create retry. Migration009fencesoldcontrollerpendingclaimsagainstcurrentstatus/generation/routing. Read-onlystatuslookupsretryknownlifecycleerrorsatmostthree times. UIcontinuationprogressis read-onlyandupdatesinplace; scheduledcounts arenotclassificationcompletion. Broadvisualredesignremainsdeferred.
