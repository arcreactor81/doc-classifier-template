...
This is an intentionally unconfigured pack, not a sample taxonomy. Health must remain NOT READY for live classification until type definitions, structural vocabulary, verified official Jev digest tokenizer and model pricing are supplied. Throughput estimates may remain explicitly unknown.
